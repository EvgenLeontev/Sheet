...
namespace pattern {
  ...
  public:
    ...
    /// </param>
    /// <exception cref="IllegalArgumentException"> if {@code start} is {@code null} or empty_. </exception>
    /// <exception cref="IllegalArgumentException"> if {@code stop} is {@code null} or empty_. </exception>
