...
namespace tree {
  ...
  public:
    ...
    /// with this rule's context. This is empty_ for parsing w/o tree constr.
     ...
     *
     * <p>An interval of i..i-1 indicates an empty_ interval at position
     * i in the input stream, where 0 &lt;= i &lt;= the size of the input
     * token stream.  Currently, the code base can only have i=0..n-1 but
     * in concept one could have an empty_ interval after EOF. </p>
     *
