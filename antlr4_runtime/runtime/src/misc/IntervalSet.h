...
namespace misc {
  ...
  public:
     ...
     * {@code null}, it is treated as though it was an empty_ set.
     */
     ...
     *
     * @return the maximum value contained in the set. If the set is empty_, this
     ...
     *
     * @return the minimum value contained in the set. If the set is empty_, this
     * method returns {@link Token#INVALID_TYPE}.
     */
