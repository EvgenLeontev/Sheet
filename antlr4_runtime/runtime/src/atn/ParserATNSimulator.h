...
namespace atn {
   ...
   *
   * <p>
   * We avoid doing full context retry when the outer context is empty_, we did not
  ...
  public:
     ...
     *
     *   a. empty_ (we'd fall out of expr to do a global FOLLOW which could
  ...
  protected:
    ...
    /// if the set is empty_, there is no viable alternative for current symbol
     ...
     * conflicting subsets, this method returns an empty_ {@link BitSet}.
     */
